...
<?php	
		if(!empty($_POST)){
            ...
            $comment=$_POST['comment'];
			    ...
			    $sqlr="UPDATE `visa_request` SET `admin_name`='$admin_name', `visa_start_date`='$from_date',`visa_end_date`='$to_date',`visa_country`='$country',`vi_comment`='$comment'  WHERE `querie_id`='$query_id'";
