...
<body>
    ...
    <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST">
        <div class="lunchdiv card">
            <fieldset><legend>Lunch System:</legend>
...
<?php
		...
		if(!empty($_POST)){
			...
			if (mysqli_num_rows($resulte) > 0) {
			    ...
			    $sqlr="INSERT INTO `lunch_book`(`emp_name`, `lunch_guest`, `admin_name`, `querie_id`, `lunch_category`, `lunch_date`, `lunch_member_count`, `lu_comment`) VALUES ('$emp_name','$guest_name','$admin_name','$query_id','$course','$order_date','$member_count','$comment')";
