                ...
                <div class="row">
                    <div class="col-sm-6 ">
                        <div class="form-group  input-group input-group-lg">
                            ...
                            <input class="form-control" id="checkin" name="checkin_date" placeholder="Check In" type="text" required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 ">
                        <div class="form-group  input-group input-group-lg">
                            ...
                            <input class="form-control" id="checkout" name="checkout_date" placeholder="Check Out" type="text" required>
                        </div>
                    </div>
                </div>
    ...
    <?php
		...
		if(!empty($_POST)){
			...
			if (mysqli_num_rows($resulte) > 0) {
			    ...
			    $sqlr="INSERT INTO `hotel_book`(`emp_name`, `admin_name`, `hotel_city`, `hotel_pre1`, `hotel_pre2`, `hotel_checkin`, `hotel_checkout`, `hotel_guestname`, `hotel_member`, `hotel_roomcount`, `query_id`, `ho_comment`) VALUES ('$emp_name','$admin_name','$city','$pref1','$pref2','$checkin_date','$checkout_date','$guest_name','$members_count','$room_count','$query_id', '$comment' )";
