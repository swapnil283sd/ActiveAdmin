                                ...
                                <table class="table" id="querytable" style=" border: 1px solid black !important ;">
                                        <thead>
                                                <tr style=" border: 1px solid black !important ;">
                                                        <th style=" border: 1px solid black !important ;    width: 85px;">Ticket No</th>
                                                        ...
                                                        <th style="border: 1px solid black !important; text-align:center; width: 165px;"> </th>
                                                </tr>
                                        </thead>
...
function myFunction(mystring) {
    ...
    xmlhttp.send();
                ...
                function gotoHome(){
                     ...
                     window.location='http://localhost/ClientPortal/getrequest.php';
                }
           ...
           function calleditPage(queryId){
               ...
               if(ho==0){
                    window.location='http://localhost/ClientPortal/updatehotel.php?query_id='+queryId;
               }else if(vi==0){
                   window.location='http://localhost/ClientPortal/updatevisa.php?query_id='+queryId;
               }else if(ta==0){
                   window.location='http://localhost/ClientPortal/updatetaxi.php?query_id='+queryId;
               }else if(lu==0){
                   window.location='http://localhost/ClientPortal/updatelunch.php?query_id='+queryId;
               }else if(fl==0){
                   window.location='http://localhost/ClientPortal/updateflight.php?query_id='+queryId;
               }
