            ...
            <div class="hoteldiv card">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 submitbutton">
                        <button type="submit" class="btn btn-primary"><i class="fa fa-upload" aria-hidden="true"></i> &nbsp;&nbsp;Update</button>
                    </div>
                    <div class="col-sm-4 ">
                    </div>
                </div>
...
<?php
		...
		if(!empty($_POST)){
            ...
            $comment=$_POST['comment'];
			    ...
			    $sqlr="UPDATE `hotel_book` SET `hotel_city`='$city',`hotel_pre1`='$pref1',`hotel_pre2`='$pref2',`hotel_checkin`='$checkin_date',`hotel_checkout`='$checkout_date',`hotel_guestname`='$guest_name',`hotel_member`='$members_count',`hotel_roomcount`='$room_count',`ho_comment`='$comment' WHERE `query_id`='$query_id'";
