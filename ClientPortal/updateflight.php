...
<body>
    ...
    <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST">
        ...
        <div class="visadiv card">
            ...
            <div class="dropdowndi ui selection dropdown">
            ...
            <div class="form-group">
                    ...
                    <textarea class="form-control" placeholder="Comment" name="comment" rows="2" id="comment"></textarea>
            </div>            
...
<?php	
		if(!empty($_POST)){
			...
			$comment=$_POST['comment'];
			    ...
			    $sqlr="UPDATE `flight_book` SET `admin_name`='$admin_name',`flight_origin`='$fromcountry',`flight_desctination`='$tocountry',`flight_start_date`='$from_date',`flight_end_date`='$to_date',`flight_on_person`='$guest_name',`flight_passport_number`='$passportno',`fl_comment`='$comment' WHERE `query_id`='$query_id'";
