            ...
            <div class="row">
                <div class="col-sm-6 " >
                    <div class="form-group  input-group input-group-lg">
                        ...
                        <input class="form-control" id="date" name="taxi_date" placeholder="Enter Starting Date" type="text" required>
                    </div>
                </div>
                <div class="col-sm-6 " >
                    <div class="form-group  input-group input-group-lg">
                        <span class="input-group-addon"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                        <input class="form-control"  name="taxi_time" placeholder="Time" type="number" required>
                    </div>
                </div>    
            </div>
            <div class="row"></div>
