        ...
        <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST">
            ...
            <div class="hoteldiv card">
                ...
                <div class="form-group  input-group input-group-lg">
                    ...
                    <input type="text" name="guest_name" class="form-control" placeholder="Guest Name" id="guestname" disabled>
                ...
                <div class="form-group  input-group input-group-lg">
                    ...
                    <input type="text" class="form-control" name="city" id="city" placeholder="Enter city, location or Hotel Name" disabled>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6 ">
                        <div class="form-group input-group input-group-lg">
                            ...
                            <input type="text" class="form-control" id="preference1" id="preferenceone" name="pref1" placeholder="Preference 1" disabled>
                        </div>
                    </div>
                    <div class="col-sm-6 ">
                        <div class="form-group input-group input-group-lg">
                            ...
                            <input type="text" class="form-control" id="preference2" name="pref2" id="preferencetwo" placeholder="Preference 2" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6 ">
                        <div class="form-group  input-group input-group-lg">
                            ...
                            <input class="form-control" id="checkin" name="checkin_date" id="checkin" placeholder="Check In" type="text" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 ">
                        <div class="form-group  input-group input-group-lg">
                            ...
                            <input class="form-control" id="checkout" name="checkout_date" id="checkout" placeholder="Check Out" type="text" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6 ">
                        <div class="form-group  input-group input-group-lg">
                            ...
                            <input class="form-control" name="members_count" id="members" placeholder="Members" type="number" min="1" disabled/>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 ">
                        <div class="form-group  input-group input-group-lg">
                            ...
                            <input class="form-control" name="room_count" name="no_room" id="noofroom" placeholder="No.of Rooms" type="number" min="1" disabled />
                        </div>
                    </div>
                </div>
