    ...
    <body>
                                ...
                                <table class="table" id="querytable" style=" border: 1px solid black !important ;">
                                        <thead>
                                                <tr style=" border: 1px solid black !important ;">
                                                        ...
                                                        <th style="border: 1px solid black !important; text-align:center; width: 215px;"> </th>
                                                </tr>
                                        </thead>
        ...
        <div class="lowerhalf">
            ...
            <script>
                ...
                $activeadminid= <?php echo $_SESSION["adminid"]; ?>;
                xmlhttprequest.open("GET","http://localhost/adminportal/backend/query_data.php?adminid="+$activeadminid,true);
                xmlhttprequest.send();
...
function myFunction(mystring) {
    ...
    xmlhttp.send();
           ...
           function calleditPage(queryId){
               ...
               if(ho==0){
                    window.location='http://localhost/adminportal/showhotel.php?query_id='+queryId;
               }else if(vi==0){
                   window.location='http://localhost/adminportal/showvisa.php?query_id='+queryId;
               }else if(ta==0){
                   window.location='http://localhost/adminportal/showtaxi.php?query_id='+queryId;
               }else if(lu==0){
                   window.location='http://localhost/adminportal/showlunch.php?query_id='+queryId;
               }else if(fl==0){
                   window.location='http://localhost/adminportal/showflight.php?query_id='+queryId;
               }
            ...
            function callraisingPage(queryId){
              window.location='http://localhost/inprocess.php?query_id='+queryId;
            }     
